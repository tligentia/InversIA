...
const platforms = [
    ...
    { name: 'ProRealTime', icon: 'fa-solid fa-chart-bar', urlTemplate: (ticker: string) => `https://www.prorealtime.com/en/search?q=${ticker}`, types: ['stock', 'crypto'] },
                    ...
                    <div className="flex items-center gap-2">
                        {platforms
                            ...
                            .map(platform => {
                                ...
                                return (
                                    <div key={platform.name} className="relative group flex items-center">
                                        <a
                                            href={url}
                                            target="_blank"
